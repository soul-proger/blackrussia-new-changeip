...
#include "vendor/EABase/config/eacompiler.h"

// Identify traits which this compiler supports, or does not support
#include "vendor/EABase/config/eacompilertraits.h"

// Identify the platform and declare the EA_xxxx defines
#include "vendor/EABase/config/eaplatform.h"
...
#include "vendor/EABase/version.h"

// Define common SI unit macros
#include "vendor/EABase/eaunits.h"
...
#ifdef __cplusplus
	#include "vendor/EABase/int128.h"
#endif
