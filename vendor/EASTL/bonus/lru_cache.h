...
#include "vendor/EASTL/list.h"
#include "vendor/EASTL/unordered_map.h"
#include "vendor/EASTL/optional.h"
#include "vendor/EASTL/utility.h" // for pair
#include "vendor/EASTL/functional.h" // for function, hash, equal_to
